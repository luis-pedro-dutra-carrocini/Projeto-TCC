...
if (isset($_POST['enviarredacao'])){
  ...
  // Enviando a redação
  $result = mysqli_query($conexao, "INSERT into tabela_redacoes(codigo_usuario, texto_naocorrigido, data_envio, titulo, tema, visualizacao, tipo, situacao) values($codigo_usuario, '".addslashes($textored)."', '$hoje', '".addslashes($titulo)."', '".addslashes($tema)."', $visu, $tipored, 0)");
...
<b>Tema:</b>
<br>
<input type="radio" name="tipotema"  id="enem" value="enem">
<label for="tipotema">ENEM</label>
&nbsp;&nbsp;
<input type="radio" name="tipotema" id="professor" value="professor">
...
&nbsp;&nbsp;
<input type="radio" name="tipotema" id="pormim" value="pormim" checked>
<label for="tipotema">Elaborado por mim</label>
<br><br>

<div id="divmeutema">
<input type="text" name="txttema" style="width: 99%;" maxlength="300" Placeholder="Tema" id="txttema">
<br><br>
</div>
...
<b>Título:</b>
<input type="text" name="txttitulo" style="width: 93%;" maxlength="50" required id="txttitulo">
<br><br>
...
<br>
<div id="divrestext">
<textarea cols="95" rows="15" style="width: 99%;" name="txtredacao" value="text"></textarea>
<br><br>
</div>
