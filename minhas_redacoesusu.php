...
<!-- Iniciando JS -->
    ...
    <div class="panel-heading" style="background-color:#363636;">
                ...
                <h2 class="panel-title" style="font-size: clamp(1em, 1em + 1vw, 1.5em);">Minhas Redações</h2>
            ...
            <table class="table">
                ...
                <thead>
                    ...
                    <tr class="filters" style="background-color:#696969;">
                        ...
                        <th><input style="font-size: clamp(1em, 1em + 0.2vw, 1.5em);" type="text" class="form-control" placeholder="Visualização" disabled></th>

                        <th><input style="font-size: clamp(1em, 1em + 0.2vw, 1.5em);" type="text" class="form-control" placeholder="Situação" disabled></th>
