...
$consulta = mysqli_query($conexao,"SELECT * from tabela_usuarios_banidos WHERE usuoupro = 0;");
...
<!-- Definindo acaracteristicas basicas para a pagina como titulo e acentuação -->

<meta charset="UTF-8">

<title>Professors Banidos</title>
...
<div class="panel-heading" style="background-color:#363636;">
                ...
                <h3 class="panel-title" style="font-size: clamp(1em, 1em + 1vw, 1.5em);">Professors Banidos</h3>
            ...
            <table class="table">
                ...
                <tr class="filters" style="background-color:#696969;">
                        ...
                        <th><input type="text" style="font-size: clamp(1em, 1em + 0.2vw, 1.5em);" class="form-control" placeholder="Motivo do Banimento" disabled></th>

                        <th><input type="text" style="font-size: clamp(1em, 1em + 0.2vw, 1.5em);" class="form-control" placeholder="Data do Banimento" disabled></th>
