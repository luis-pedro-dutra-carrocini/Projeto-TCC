    ...
    <div class="row">
        <div class="panel panel-primary filterable">
            <div class="panel-heading">
                <h3 class="panel-title">Professors Banidos</h3>
            ...
            <table class="table">
                <thead>
                    <tr class="filters">
                        ...
                        <th><input type="text" class="form-control" placeholder="Motivo do Banimento" disabled></th>
                        <th><input type="text" class="form-control" placeholder="Data do Banimento" disabled></th>
                        <th><label>Incluir</label></th>
