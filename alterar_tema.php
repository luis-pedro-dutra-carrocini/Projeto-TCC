...
if(isset($_POST["Alterar"])){
    ...
    $anonovo = Addslashes(trim($_POST['ano']));
    ...
    <div class="box" align="left">
        ...
        <form action="" method="POST" name="f1">
            ...
            <fieldset>
                ...
                <input type="text" style="width: 88%; border: 2px solid white; color:white; background-color: black;" name="txttema" id="email" class="inputUser" autofocus maxlength="300" value="<?php echo $tema;?>" required>
