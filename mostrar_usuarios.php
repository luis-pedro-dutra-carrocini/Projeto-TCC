...
// Pegando dados do bd
$consulta = mysqli_query($conexao,"SELECT * from tabela_usuario order by nome;");
...
if(!isset($_SESSION["senha_adm"])){
  ...
  // Obteno o nome do adm via sessão
...
<!-- definindo caracteristicas basicas para a pagina, vomo titulo e acentuação -->
<meta charset="UTF-8">
...
<div class="panel-heading" style="background-color:#363636;">
                <h3 class="panel-title" style="font-size: clamp(1em, 1em + 1vw, 1.5em);">Usuários</h3>
...
// Codigo usuario
echo "<td>".$dado['codigo_usuario']."</td>";
...
<div>
&nbsp;&nbsp;
<a href='alterar_usuario.php?nome=$dado[nome]' title='Alterar'><img src='img/alterar.png' height ='30px' width='30px' align='center'></a>
&nbsp;&nbsp;
<a href='confex_usu.php?nome=$dado[nome]' title='Excluir'><img src='img/deletar.png' height ='30px' width='30px' align='center'></a>
&nbsp;&nbsp;
<a href='ban_usu.php?nome=$dado[nome]' title='Banir'><img src='img/banir.png' height ='30px' width='30px' align='center'></a>
&nbsp;&nbsp;
</div>
</td>";
echo "</tr>";
