    ...
    <div class="box" align="left">
        ...
        <form action="" method="POST" name="f1">
            ...
            <fieldset>
                ...
                <input style="font-size: clamp(1em, 1em + 0.2vw, 1.5em);" class="form-control" value="<?php echo $email;?>" autofocus placeholder="E-Mail" type="email" name="email" id="email" onblur="validacaoEmail(f1.email)" maxlength="256" value="<?php echo $email;?>" required>
            ...
            <input style="font-size: clamp(1em, 1em + 0.2vw, 1.5em);" value="<?php echo $nomemos;?>" name="nome" maxlength="50" placeholder="Nome" required class="form-control" pattern="[A-Za-záàâãéèêíïóôõöúçñÁÀÂÃÉÈÍÏÓÔÕÖÚÇÑ ]+$" value="<?php echo $nomemos;?>" placeholder="Nome" type="text">
            </div>
            <br>
