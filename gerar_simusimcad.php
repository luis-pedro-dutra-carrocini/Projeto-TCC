...
// Função para abrir a pagina gerar aletar dados
...
<div class="box" align="left">
        ...
        <form action="prova_personalizada.php" method="POST" name="f1">
...
<button type="button" id="cancelar" name="btn_canadiadm" onclick="home()">Cancelar</button>
