...
if($dados->num_rows > 0){
  ...
  $consulta = mysqli_query($conexao,"SELECT * from tabela_temasredacoes where tipo = 1 order by ano;");
...
<title>Temas de redações propostas por Professores</title>
...
<div class="panel-heading" style="background-color:#363636;">
                ...
                <h3 class="panel-title" style="font-size: clamp(1em, 1em + 1vw, 1.5em);">Temas feitos por Professores</h3>
