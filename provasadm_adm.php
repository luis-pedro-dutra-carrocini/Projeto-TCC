...
if(!isset($_SESSION["senha_adm"])){
  ...
  // Redirecionando para a pagian index, pois a sessão não foi iniciada
...
$consulta = mysqli_query($conexao,"SELECT * from tabela_provas_adm where (tipoprova = 1 and codigo_adm != $codigo_adm) order by nome;");
...
<title>Simulados de Professores</title>
...
<div class="panel-heading" style="background-color:#363636;">
                ...
                <h3 class="panel-title" style="font-size: clamp(1em, 1em + 1vw, 1.5em);">Simulados feitos por Professores</h3>
            ...
            <table class="table">
                ...
                <tr class="filters" style="background-color:#696969;">
                        ...
                        <th><input type="text" style="font-size: clamp(1em, 1em + 0.2vw, 1.5em);" class="form-control" placeholder="Professor" disabled></th>

                        <th><input type="text" style="font-size: clamp(1em, 1em + 0.2vw, 1.5em);" class="form-control" placeholder="Qt. Questões" disabled></th>
...
$codadm = $dado['codigo_adm'];

$selectadm = mysqli_query($conexao,"SELECT * from tabela_adm where codigo = $codadm;");

$dadoadm = $selectadm->fetch_array();
...
echo "<td><a href='provacad_adm.php?codigo=$dado[codigo]'><font color='MidnightBlue'><u>".$dado['nome']."</u></font></a></td>";

echo "<td>".$dadoadm['nome']."</td>";

echo "<td>".$dado['numero_questoes']."</td>";

echo "<td><a href='gabaritoprovacad_adm.php?codigoadm=$dado[codigo]'><font color='MidnightBlue'><u>Gabarito</u></font></a></td>";
...
if ($niveladm == "admgeral" || $niveladm == "adm"){
    ...
    if ($dadoadm['nivel'] != "admgeral"){

    echo "<td><div>

    &nbsp;&nbsp;

    <a href='alterar_provaprofessor.php?codigo=$dado[codigo]' title='Alterar Nome'><img src='img/alterar.png' height ='30px' width='30px' align='center'></a>

    &nbsp;&nbsp;

    <a href='confex_provaprofessor.php?codigo=$dado[codigo]' title='Excluir'><img src='img/deletar.png' height ='30px' width='30px' align='center'></a></div></td>";

    echo "</tr>";

    }else{

        echo "<td align ='center'>Inalterável</td></tr>";

    }

    }else{

        if ($dadoadm['nivel'] != "admgeral" && $dadoadm['nivel'] != "adm"){
