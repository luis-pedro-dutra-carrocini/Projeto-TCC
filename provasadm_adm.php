    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        ...
        <li class="menu-active"><a href="pagina_adm.php">Home</a></li>
          ...
          // Verificando quais itens do cabeçalho deveram aparecer, de acordo com o nivel do adm
    ...
    <div class="row">
        <div class="panel panel-primary filterable">
            <div class="panel-heading">
                <h3 class="panel-title">Provas feitas por Professores</h3>
...
echo "<tr>";
echo "<td><a href='provacad_adm.php?codigo=$dado[codigo]'>".$dado['nome']."</a></td>";
echo "<td>".$dadoadm['nome']."</td>";
echo "<td>".$dado['numero_questoes']."</td>";
echo "<td><a href='gabaritoprovacad_adm.php?codigoadm=$dado[codigo]'>Gabarito</a></td>";
