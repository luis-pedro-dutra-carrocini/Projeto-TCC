    ...
    <div class="row">
        <div class="panel panel-primary filterable">
            <div class="panel-heading">
                <h3 class="panel-title">Sua Classificação</h3>
            </div>
            <table class="table">
                <thead>
                    <tr class="filters">
                        <th><input type="text" class="form-control" placeholder="Classificação" disabled></th>
                        ...
                        <th><input type="text" class="form-control" placeholder="Tempo por pergunta (M)" disabled></th>
                    </tr>
...
echo "<tr>";
echo "<td>".$classificacao."º Lugar</td>";
...
<!-- Iniciando JS -->
    ...
    <div class="row">
        <div class="panel panel-primary filterable">
            <div class="panel-heading">
                <h3 class="panel-title">Ranking dos Usuários</h3>
