...
if($slusu->num_rows > 0){
  ...
  $codigo_usuario = $dadousu['codigo_usuario'];

}



// Selecionando os simulados a serem mostrados

$consulta = mysqli_query($conexao,"SELECT * from tabela_provas_usuario where tipoprova = 1 and codigo_usuario !=  $codigo_usuario order by nome;");
...
<title>Simulados feitos por Usuários</title>
