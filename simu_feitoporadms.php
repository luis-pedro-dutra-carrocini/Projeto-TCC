...
if(!isset($_SESSION["senha_usuario"]) && !isset($_SESSION["nome_cad"])){
  ...
  // Redeirecionando para a pagina index, pois a sessão não foi iniciada
...
// Obtendo as provas dos professores

$consulta = mysqli_query($conexao,"SELECT * from tabela_provas_adm where tipoprova = 1 order by nome;");
...
<title>Simulados feitos por Professores</title>
...
<!-- Iniciando JS -->
    ...
    <div class="panel-heading" style="background-color:#363636;">
                ...
                <h2 class="panel-title" style="font-size: clamp(1em, 1em + 1vw, 1.5em);">Simulados feitos por Professores</h2>
...
echo "<td><a href='simu_professor.php?codigo=$dado[codigo]'><font color='MidnightBlue'><u>".$dado['nome']."</u></font></a></td>";
