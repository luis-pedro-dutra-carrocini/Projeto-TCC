...
if(!empty($_GET['codigo'])){
    ...
    // Selecinando os dados da prova
    $sqlSelect = "SELECT * FROM tabela_provas_adm WHERE (codigo=$codigoprova and tipoprova = 1);";
    ...
    else
    {
      ...
      // Redirecionando para a pagina simulados feitos por professores, pois a prova não existe
      header('Location: simu_feitoporadms.php');
      exit;
    }
}else{

  // Redirecionando para a pagina simulados feitos por professores, pois o codigo não chegou
  header('Location: simu_feitoporadms.php');
  exit;
}
...
// Passando a quantidade de perguntas para a sessão
...
// Passando a hora de inicio para a sessão
$_SESSION['hora_inicio'] = $hora_inicio;

// Verificando a quantidade de perguntas
// Para ver quais devem ser exibidas
if ($qtperguntas > 0){
...
<!-- Definindo o titulo da pagina como o nome da prova -->
...
<!-- Legenda do form -->
<legend style="color:grey31; font-size:25px; font-weight: bold;"><?php echo $dado['nome']; ?></legend>
<br>
