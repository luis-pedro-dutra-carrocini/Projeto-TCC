...

{
  ...
  // Verificando se o usuário é antigo ou 
...
// Verificando se o codigo chegou da pagina minhas provas
...

{
    ...
    $codigoprova = $_GET['codigo'];



    // Obtendo os dados da prova

    $sqlSelect = "SELECT * FROM tabela_provas_usuario WHERE codigo=$codigoprova";
...

    {
        ...
        // Redirecionando para a pagina usuario, pois a prova não existe
...
// Verificando se o codigo chegou da pagina todas as provas realizadas

}elseif(!empty($_GET['codigorea']))

{
  ...
  $codigoprova = $_GET['codigorea'];



  // Obtendo os dados da prova

  $sqlSelect = "SELECT * FROM tabela_provasrealizadas_usuario WHERE codigo=$codigoprova";
  ...
  // Definindo a data como o nome da prova

  $nome_prova = $data_realizacao;
...
// Obtendo quantidadde de perguntas

$qtperguntas = $dado['numero_questoes'];



// Colocando a quantidade de perguntas na sessão para o proximo formulário
...
// Colocando a hora de inicio na sessão para o proximo formulário
...
<title><?php echo $nome_prova; ?></title>
...
function novared() {
    ...
    if (resultadovoltar == true) {
      ...
      location.href='nova_redacao.php';
      ...
      <nav id="nav-menu-container">
        ...
        <li class="menu-has-children"><a>Simulados</a>
            ...
            <ul>
              ...
              <li><a onclick="simumeu()">Meus Simulados</a></li>
          ...
          <li class="menu-has-children"><a >Redações</a>
            ...
            <ul>
              ...
              <li><a onclick="novared()">Escrever</a></li>

              <li><a onclick="redusu()">Outros usuários</a></li>
...
<legend style="color:grey31; font-size:25px; font-weight: bold;"><?php echo $nome_prova; ?></legend>
...
// Verificando caracteristicas 1

echo "<b>Questão 1:</b>";

echo "<br><br>";

print "<p>".nl2br($per1['pergunta'])."</p>";
...
echo "<input type='radio' name='radper1'  required id='radper1' value='Letra A'>";
...
// Verificando caracteristicas 2

echo "<b>Questão 2:</b>";

echo "<br><br>";

print "<p>".nl2br($per2['pergunta'])."</p>";
...
// Verificando caracteristicas 3

echo "<b>Questão 3:</b>";

echo "<br><br>";

print "<p>".nl2br($per3['pergunta'])."</p>";
...
// Verificando caracteristicas 4

echo "<b>Questão 4:</b>";

echo "<br><br>";

print "<p>".nl2br($per4['pergunta'])."</p>";
...
// Verificando caracteristicas 5

echo "<b>Questão 5:</b>";

echo "<br><br>";

print "<p>".nl2br($per5['pergunta'])."</p>";
