  ...
  $codigo_adm = $dado['codigo'];
    ...
    if(isset($_POST["alterar"])){
        ...
        if ($confalte == "True"){
            ...
            $novonome = Addslashes(trim($_POST['nome']));
                ...
                $sqlInsert = "UPDATE tabela_provas_adm SET nome='$novonome',tipoprova=$novotipo WHERE codigo=$codigo;";
                ...
                $script = "<script>alert('Prova alterada com sucesso');location.href='provas_geradasadm.php';</script>";
    ...
    if(!empty($_GET['codigo'])){
        ...
        if($result->num_rows > 0){
         ...
         // verificando o tipo, para mostar no formulario
         ...
         if ($tipo == 1){
            ...
            // Redirecionando para a pagina provas geradas professores, pois a prova não existe
        ...
        // Redirecionando para a pagina provas geradas professores, poiso codigo não chegou via GET
...
<!-- Defnindo caracteristicas basicas, como acenttuçao e titulo -->
        ...
        <form action="" method="POST" name="f1">
            ...
            <fieldset>
                ...
                <label for="nome" class="labelInput">Nome:</label>
                    ...
                    <input type="text" name="nome" style="width: 88%; border: 2px solid white; color:white; background-color: black;" id="nome" class="inputUser" pattern="[A-Za-záàâãéèêíïóôõöúçñÁÀÂÃÉÈÍÏÓÔÕÖÚÇÑ ]+$" maxlength="50" value="<?php echo $nomemos;?>" required>
                ...
                <!-- Quem pode ver a prova -->

                <b>Quem pode ver:</b><br>
