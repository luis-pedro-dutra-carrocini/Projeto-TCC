...
$consulta = mysqli_query($conexao,"SELECT * from tabela_usuarios_banidos WHERE usuoupro = 1;");
...
<!-- Definindo cracteristicas basicas para a pagina, como titulo e acentuação -->

<meta charset="UTF-8">

<title>Usuários Banidos</title>
...
<div class="panel-heading" style="background-color:#363636;">
                ...
                <h3 class="panel-title" style="font-size: clamp(1em, 1em + 1vw, 1.5em);">Usuários Banidos</h3>
            ...
            <table class="table">
                ...
                <tr class="filters" style="background-color:#696969;">
                        ...
                        <th><input type="text" class="form-control" style="font-size: clamp(1em, 1em + 0.2vw, 1.5em);" placeholder="#" disabled></th>

                        <th><input type="text" class="form-control" style="font-size: clamp(1em, 1em + 0.2vw, 1.5em);" placeholder="Nome" disabled></th>

                        <th><input type="text" class="form-control" style="font-size: clamp(1em, 1em + 0.2vw, 1.5em);" placeholder="E-Mail" disabled></th>

                        <th><input type="text" class="form-control" style="font-size: clamp(1em, 1em + 0.2vw, 1.5em);" placeholder="Motivo do Banimento" disabled></th>

                        <th><input type="text" class="form-control" style="font-size: clamp(1em, 1em + 0.2vw, 1.5em);" placeholder="Data do Banimento" disabled></th>
...
<a href='conflib_ban.php?nome=$dado[nome]' title='Liberar do Banimento'><img src='img/incluir.png' height ='30px' width='30px' align='center'></a>
