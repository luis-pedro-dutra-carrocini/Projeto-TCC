    ...
    <div class="row">
        <div class="panel panel-primary filterable">
            <div class="panel-heading">
                <h3 class="panel-title">Provas feitas por Usuários</h3>
...
echo "<tr>";
echo "<td><a href='provacad_adm.php?codigousu=$dado[codigo]'>".$dado['nome']."</a></td>";
echo "<td>".$dadousu['nome']."</td>";
echo "<td>".$dado['numero_questoes']."</td>";
echo "<td><a href='gabaritoprovacad_adm.php?codigousu=$dado[codigo]'>Gabarito</a></td>";
