...
$consulta = mysqli_query($conexao,"SELECT * from tabela_provas_usuario where tipoprova = 1  order by nome;");
...
<title>Simulados de Usuários</title>
...
<div class="panel-heading" style="background-color:#363636;">
                ...
                <h3 class="panel-title" style="font-size: clamp(1em, 1em + 1vw, 1.5em);">Simulados feitos por Usuários</h3>
...
$codusu = $dado['codigo_usuario'];

$selectusu = mysqli_query($conexao,"SELECT * from tabela_usuario where codigo_usuario = $codusu;");

$dadousu = $selectusu->fetch_array();
...
echo "<td><a href='provacad_adm.php?codigousu=$dado[codigo]'><font color='MidnightBlue'><u>".$dado['nome']."</u></font></a></td>";

echo "<td>".$dadousu['nome']."</td>";

echo "<td>".$dado['numero_questoes']."</td>";

echo "<td><a href='gabaritoprovacad_adm.php?codigousu=$dado[codigo]'><font color='MidnightBlue'><u>Gabarito</u></font></a></td>";
...
if ($niveladm == "admgeral" || $niveladm == "adm"){
    ...
    <a href='alterar_provaprofessor.php?codigousu=$dado[codigo]' title='Alterar Nome'><img src='img/alterar.png' height ='30px' width='30px' align='center'></a>

    &nbsp;&nbsp;

    <a href='confex_provausuporadm.php?codigo=$dado[codigo]' title='Excluir'><img src='img/deletar.png' height ='30px' width='30px' align='center'></a></div></td>";
