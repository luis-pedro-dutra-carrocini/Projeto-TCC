...
<div class="panel-heading" style="background-color:#363636;">
                ...
                <h3 class="panel-title" style="font-size: clamp(1em, 1em + 1vw, 1.5em);">Meus Simulados</h3>
            ...
            <table class="table">
                ...
                <tr class="filters" style="background-color:#696969;">
                        ...
                        <th><input type="text" style="font-size: clamp(1em, 1em + 0.2vw, 1.5em);" class="form-control" placeholder="Quem pode Ver" disabled></th>
...
$consulta = mysqli_query($conexao,"SELECT * from tabela_provas_adm where codigo_adm = $codigo_adm order by nome;");
...
echo "<td><u><a href='provacad_adm.php?codigomeu=$dado[codigo]'><font color='MidnightBlue'>$dado[nome]</font></a></u></td>";

echo "<td>".$dado['numero_questoes']."</td>";

echo "<td>".$tipoprova."</td>";

echo "<td><a href='gabaritoprovacad_adm.php?codigo=$dado[codigo]'><font color='MidnightBlue'><u>Gabarito</font></u></td>";



echo "<td><a href='alterar_provaadm.php?codigo=$dado[codigo]' title='Alterar'><img src='img/alterar.png' height ='20px' width='20px' align='center'></a>

&nbsp;&nbsp;

<a href='confex_provaadm.php?codigo=$dado[codigo]' title='Deletar'><img src='img/deletar.png' height ='20px' width='20px' align='center'></a>
