    ...
    <div class="row">
        <div class="panel panel-primary filterable">
            <div class="panel-heading">
                <h3 class="panel-title">Minhas Provas</h3>
            ...
            <table class="table">
                <thead>
                    <tr class="filters">
                        ...
                        <th><input type="text" class="form-control" placeholder="Quem pode Ver" disabled></th>
                        <th><label>Gabarito</label></th>
...
echo "<td><a href='provacad_adm.php?codigomeu=$dado[codigo]'>$dado[nome]</a></td>";
echo "<td>".$dado['numero_questoes']."</td>";
echo "<td>".$tipoprova."</td>";
echo "<td><a href='gabaritoprovacad_adm.php?codigo=$dado[codigo]'>Gabarito</td>";
