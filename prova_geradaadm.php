...
if(!isset($_SESSION["senha_adm"])){
  ...
  // Verificando se pelo menos uma checbox foi selecionada
  ...
  // Redirecioando para a pagina ferar provas, pois nenhuma disciplina foi escolhida
...
// Obtendo o numero de questões

$qtperguntas = $_POST['qtperguntas'];



// enviando o numero de questões via sessão, para usar em outro formulário

$_SESSION['qtperguntas'] = $qtperguntas;



// Verificando quais checboxs foram selecionadas
...
OR codigo_disciplina = $historia OR codigo_disciplina = $biologia OR codigo_disciplina = $fisica OR codigo_disciplina = $quimica");
...
if($slq_qtques->num_rows <= $qtperguntas){
  ...
  $script = "<script>alert('Erro: Não foi possível gerar o simulado. Quantidade de questões exigidas, maior que a quantidade existente. Diminua a quantidade, ou selecione outras disciplinas.');location.href='gerar_provaadm.php';</script>";
...
OR codigo_disciplina = $historia OR codigo_disciplina = $biologia OR codigo_disciplina = $fisica OR codigo_disciplina = $quimica Order By rand() LIMIT 1;");
...
OR codigo_disciplina = $historia OR codigo_disciplina = $biologia OR codigo_disciplina = $fisica OR codigo_disciplina = $quimica) and codigo_pergunta != $codper1 Order By rand() LIMIT 1;");
...
OR codigo_disciplina = $historia OR codigo_disciplina = $biologia OR codigo_disciplina = $fisica OR codigo_disciplina = $quimica) and (codigo_pergunta != $codper1 and codigo_pergunta != $codper2) Order By rand() LIMIT 1;");
...
OR codigo_disciplina = $historia OR codigo_disciplina = $biologia OR codigo_disciplina = $fisica OR codigo_disciplina = $quimica) and (codigo_pergunta != $codper1 and codigo_pergunta != $codper2 and codigo_pergunta != $codper3) Order By rand() LIMIT 1;");
...
OR codigo_disciplina = $historia OR codigo_disciplina = $biologia OR codigo_disciplina = $fisica OR codigo_disciplina = $quimica) and (codigo_pergunta != $codper1 and codigo_pergunta != $codper2 and codigo_pergunta != $codper3 and codigo_pergunta != $codper4) Order By rand() LIMIT 1;");
...
and codigo_pergunta != $codper5) Order By rand() LIMIT 1;");
...
and codigo_pergunta != $codper5 and codigo_pergunta != $codper6) Order By rand() LIMIT 1;");
...
and codigo_pergunta != $codper5 and codigo_pergunta != $codper6 and codigo_pergunta != $codper7) Order By rand() LIMIT 1;");
...
and codigo_pergunta != $codper5 and codigo_pergunta != $codper6 and codigo_pergunta != $codper7 and codigo_pergunta != $codper8) Order By rand() LIMIT 1;");
...
and codigo_pergunta != $codper5 and codigo_pergunta != $codper6 and codigo_pergunta != $codper7 and codigo_pergunta != $codper8 and codigo_pergunta != $codper9) Order By rand() LIMIT 1;");
...
if ($qtperguntas>10) {
  ...
  and codigo_pergunta != $codper5 and codigo_pergunta != $codper6 and codigo_pergunta != $codper7 and codigo_pergunta != $codper8 and codigo_pergunta != $codper9 and codigo_pergunta != $codper10) Order By rand() LIMIT 1;");
...
if ($qtperguntas>15) {
  ...
  and codigo_pergunta != $codper11 and codigo_pergunta != $codper12 and codigo_pergunta != $codper13 and codigo_pergunta != $codper14 and codigo_pergunta != $codper15) Order By rand() LIMIT 1;");
  ...
  and codigo_pergunta != $codper16) Order By rand() LIMIT 1;");
  ...
  and codigo_pergunta != $codper16 and codigo_pergunta != $codper17) Order By rand() LIMIT 1;");
  ...
  and codigo_pergunta != $codper16 and codigo_pergunta != $codper17 and codigo_pergunta != $codper18) Order By rand() LIMIT 1;");
  ...
  and codigo_pergunta != $codper16 and codigo_pergunta != $codper17 and codigo_pergunta != $codper18 and codigo_pergunta != $codper19) Order By rand() LIMIT 1;");
...
if ($qtperguntas>20) {
  ...
  and codigo_pergunta != $codper16 and codigo_pergunta != $codper17 and codigo_pergunta != $codper18 and codigo_pergunta != $codper19 and codigo_pergunta != $codper20) Order By rand() LIMIT 1;");
...
if ($qtperguntas>45) {
  ...
  and codigo_pergunta != $codper41 and codigo_pergunta != $codper42 and codigo_pergunta != $codper43 and codigo_pergunta != $codper44 and codigo_pergunta != $codper45) Order By rand() LIMIT 1;");
  ...
  and codigo_pergunta != $codper46) Order By rand() LIMIT 1;");
  ...
  and codigo_pergunta != $codper46 and codigo_pergunta != $codper47) Order By rand() LIMIT 1;");
  ...
  and codigo_pergunta != $codper46 and codigo_pergunta != $codper47 and codigo_pergunta != $codper48) Order By rand() LIMIT 1;");
  ...
  and codigo_pergunta != $codper46 and codigo_pergunta != $codper47 and codigo_pergunta != $codper48 and codigo_pergunta != $codper49) Order By rand() LIMIT 1;");
...
if ($qtperguntas>50) {
  ...
  and codigo_pergunta != $codper46 and codigo_pergunta != $codper47 and codigo_pergunta != $codper48 and codigo_pergunta != $codper49 and codigo_pergunta != $codper50) Order By rand() LIMIT 1;");
...
<!-- Definindo caracteristicas basicas para a pagiina --->
...
<legend style="color:grey31; font-size:25px; font-weight: bold;">Simulado ENEM</legend>
...
<!-- Inserindo formulario, para salvar a prova -->

<div class="box">

<fieldset>

<legend style="color:grey31; font-size:25px; font-weight: bold;">Salvar Prova</legend>

<br><br>

<form method="POST" action="salvandoprova_adm.php">



<b>Nome da Prova:</b>

<input type="text" name="nome_prova" class="inputUser" style="width: 80%;" maxlength="50" required>

<br><br><br>



<b>Quem Pode ver?<br><br>

<input type="radio" name="radsalvar" value="todos" checked>Todos

<input type="radio" name="radsalvar" value="pessoal">Somente Eu
...
<input type="submit" id="finalizar" name="btn_salvar" value="Salvar Prova">
