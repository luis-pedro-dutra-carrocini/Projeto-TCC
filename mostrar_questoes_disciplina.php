...
if(!empty($_GET['codigo'])){
    ...
    if($sql_dis->num_rows > 0){
        ...
        // Redirecionando para a pagina mostrar questoes, pois a disciplina não existe
    ...
    $consulta = mysqli_query($conexao,"SELECT * from tabela_pergunta where codigo_disciplina = $codigo_disciplina order by ano");
    ...
    // Redirecionando para a pagina mostrar questoes, pois o codigo não chegou via GET
...
<div class="panel-heading" style="background-color:#363636;">
                ...
                <h3 class="panel-title" tyle="font-size: clamp(1em, 1em + 1vw, 1.5em);">Questões</h3>
            ...
            <table class="table">
                ...
                <thead>
                    ...
                    <tr class="filters" style="background-color:#696969;">
                        ...
                        <th><input type="text" style="font-size: clamp(1em, 1em + 0.1vw, 1.5em);" class="form-control" placeholder="Ano" disabled></th>

                        <th><input type="text" style="font-size: clamp(1em, 1em + 0.1vw, 1.5em);" class="form-control" placeholder="Questão" disabled></th>

                        <th><input type="text" style="font-size: clamp(1em, 1em + 0.1vw, 1.5em);" class="form-control" placeholder="Alternativa Correta" disabled></th>

                        <th><input type="text" style="font-size: clamp(1em, 1em + 0.1vw, 1.5em);" class="form-control" placeholder="Imagem" disabled></th>
...
// Inserindo os dados na tabela da página
...
echo "<td align='center'>".$dado["ano"]."</td>";
...
echo "<td>".$alternativa_correta."</td>";

echo "<td>".$dado["imagem"]."</td>";



// Inserindo botões alterar e excluir 

echo "<td align='center' height ='35'>

<div>

<a href='alterar_questao.php?codigo=$dado[codigo_pergunta]' title='Alterar'><img src='img/alterar.png' height ='30px' width='30px' align='center'></a>

<br><br><br>

<a href='confex_ques.php?codigo=$dado[codigo_pergunta]' title='Excluir'><img src='img/deletar_q.png' height ='30px' width='30px' align='center'></a>
...
$(document).ready(function(){
    ...
    $('.filterable .filters input').keyup(function(e){
        ...
        if ($filteredRows.length === $rows.length) {
            ...
            $table.find('tbody').prepend($('<tr class="no-result text-center"><td colspan="'+ $table.find('.filters th').length +'">Nenhuma Questão Encontrada</td></tr>'));
