            ...
            <table class="table">
                ...
                <thead>
                    ...
                    <tr class="filters">
                        ...
                        <th><input type="text" class="form-control" placeholder="Questão" disabled></th>

                        <th><input type="text" class="form-control" placeholder="Alternativa Correta" disabled></th>
...
echo "<td align='center'>".$dado["codigo_pergunta"]."</td>";
