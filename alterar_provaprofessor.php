        ...
        <form action="" method="POST" name="f1">
            ...
            <fieldset>
                ...
                <label for="nome" class="labelInput">Nome</label>
                    <input type="text" name="nome" id="nome" style="width: 88%; border: 2px solid white; color:white; background-color: black;" class="inputUser" maxlength="50" value="<?php echo $nomemos;?>" required>
