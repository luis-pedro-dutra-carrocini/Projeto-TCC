    ...
    <div class="row">
        <div class="panel panel-primary filterable">
            <div class="panel-heading">
                <h3 class="panel-title">Meus Simulados</h3>
            ...
            <table class="table">
                <thead>
                    <tr class="filters">
                        ...
                        <th><input type="text" class="form-control" placeholder="Gabarito" disabled></th>
...
echo "<td><a href='gabaritoprovacad_usu.php?codigo=$dado[codigo]'>Gabarito</a></td>";
echo "<td><a href='alterar_provausuario.php?codigo=$dado[codigo]' title='Alterar'><img src='img/alterar.png' height ='20px' width='20px' align='center'></a>
&nbsp;&nbsp;
<a href='confex_provausu.php?codigo=$dado[codigo]' title='Deletar'><img src='img/deletar.png' height ='20px' width='20px' align='center'></a></td>";
echo "</tr>";
}
?>
                </tbody>
