...
<title>Redações de Outros Usuários</title>
...
<!-- Iniciando JS -->
    ...
    <div class="panel-heading" style="background-color:#363636;">
                ...
                <h3 class="panel-title" style="font-size: clamp(1em, 1em + 1vw, 1.5em);">Redações</h3>
            ...
            <table class="table">
                ...
                <thead>
                    ...
                    <tr class="filters" style="background-color:#696969;">
                        ...
                        <th><input style="font-size: clamp(1em, 1em + 0.2vw, 1.5em);" type="text" class="form-control" placeholder="Data Envio" disabled></th>

                        <th><input style="font-size: clamp(1em, 1em + 0.2vw, 1.5em);" type="text" class="form-control" placeholder="Data Correção" disabled></th>

                        <th><input style="font-size: clamp(1em, 1em + 0.2vw, 1.5em);" ype="text" class="form-control" placeholder="Situação" disabled></th>

                        <th><input style="font-size: clamp(1em, 1em + 0.2vw, 1.5em);" type="text" class="form-control" placeholder="Pontuação" disabled></th>

                        <th><input style="font-size: clamp(1em, 1em + 0.2vw, 1.5em);" type="text" class="form-control" placeholder="Corrigido por" disabled></th>´

                        <th><input style="font-size: clamp(1em, 1em + 0.2vw, 1.5em);" type="text" class="form-control" placeholder="Feita por" disabled></th>
...
$consulta = mysqli_query($conexao,"SELECT * from tabela_redacoes where (codigo_usuario != $codigo_usuario and visualizacao = 1);");
...
echo "<td><a href='redacao_usu.php?codigo=".$dado['codigo']."'><font color='MidnightBlue'><u>".$dado['tema']."</u></font></a></td>";
...
$codigored_usu = $dado['codigo_usuario'];

$sqlusu = mysqli_query($conexao,"SELECT * from tabela_usuario where codigo_usuario = $codigored_usu;");

$dadousured=$sqlusu->fetch_array();

$usuario = $dadousured['nome'];
