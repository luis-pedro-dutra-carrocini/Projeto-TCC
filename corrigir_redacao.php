...
<nav id="nav-menu-container">
  ...
  // Verificando quais itens se deve msotrar no cabeçalho, de acordo com o nivel do adm
...
<b>Título:</b> <?php echo $titulo_antigo; ?>
<br><br>
...
<textarea cols="95" rows="15" style="width: 99%;" name="txtredacao" value="text"><?php echo $texcorr; ?></textarea>
<br><br>
</div>
...
<b>Comentário:</b>
<textarea cols="95" rows="5" style="width: 99%;" name="comentario" value="text" required><?php echo $comentario_antigo; ?></textarea>
<br><br>

<b>Pontuação:</b>
<input type="number" maxlength="4" name="pontuacao" style="width: 10%;" required value="<?php echo $pontuacao_antiga; ?>">
<br><br>
