...
if(!isset($_SESSION["senha_adm"])){
  ...
  if ($nivel == "admgeral" || $nivel == "adm"){
    ...
    $consulta = mysqli_query($conexao,"SELECT * from tabela_adm where (nivel != 'admgeral' and nivel != 'adm' and codigo != 0 and codigo != 1) order by nome;");



    // Se for adm geral

    }elseif ($nivel == "admgeral"){



    // Obtendo os adms, com classificação normal, adm e de corretores

    $consulta = mysqli_query($conexao,"SELECT * from tabela_adm where (nivel != 'admgeral' and codigo != 0 and codigo != 1) order by nome;");
...
<div class="panel-heading" style="background-color:#363636;">
                ...
                <h3 class="panel-title" style="font-size: clamp(1em, 1em + 1vw, 1.5em);">Professores</h3>
            ...
            <table class="table">
                ...
                <tr class="filters" style="background-color:#696969;">
                        ...
                        <th><input type="text" style="font-size: clamp(1em, 1em + 0.2vw, 1.5em);" class="form-control" placeholder="E-Mail" disabled></th>

                        <th><input type="text" style="font-size: clamp(1em, 1em + 0.2vw, 1.5em);" class="form-control" placeholder="Nível" disabled></th>

                        <th><label>Alterar / Excluir / Banir</label></th>
...
// Obtendo o nivel do professor

if ($dado['nivel'] == "adm"){

    $nivel_prof = "ADM";

}elseif ($dado['nivel'] == "corretor"){

    $nivel_prof = "Corretor";

}elseif ($dado['nivel'] == "professor"){
...
echo "<td>".$nivel_prof."</td>";



// Inserindo os botões alterar e excluir 
...
<a href='alterar_professor.php?nome=$dado[nome]' title='Alterar'><img src='img/alterar.png' height ='30px' width='30px' align='center'></a>

&nbsp;&nbsp;

<a href='confex_adm.php?nome=$dado[nome]' title='Excluir'><img src='img/deletar.png' height ='30px' width='30px' align='center'></a>";



// Verificando o nivel do adm, para ver se é conveniente banilo

if ($dado['nivel'] != "corretor" && $dado['nivel'] != "adm"){

echo "

&nbsp;&nbsp;

<a href='ban_pro.php?nome=$dado[nome]' title='Banir'><img src='img/banir.png' height ='30px' width='30px' align='center'></a>
...
$(document).ready(function(){
    ...
    $('.filterable .filters input').keyup(function(e){
        ...
        if ($filteredRows.length === $rows.length) {
            ...
            $table.find('tbody').prepend($('<tr class="no-result text-center"><td colspan="'+ $table.find('.filters th').length +'">Nenhum Professor Encontrado</td></tr>'));
