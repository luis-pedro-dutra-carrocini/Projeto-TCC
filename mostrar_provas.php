...
<meta charset="UTF-8"> 
<title>Provas e Gabaritos ENEM</title>
...
<div class='box' Align="left" style="color:white; width:95%; font-size: clamp(1em, 1em + 0.2vw, 1.5em);">
...
while ($hoje >= 2009){
  ...
  echo "<div class='box' Align='left'>Provas de ".$hoje."</div><br>";
  
  $consulta = mysqli_query($conexao,"SELECT * from tabela_provasenem where (ano=$hoje and dia='1° Dia') order by nomeprova;");
  while ($dado=$consulta->fetch_array()) { 
    echo "1° Dia - <a href='provas_enem/".$dado['prova']."'>".$dado['nomeprova']."</a> - <a href='provas_enem/".$dado['gabarito']."'>Gabarito</a><br>";
  }
  echo "<br>";
  $consulta2 = mysqli_query($conexao,"SELECT * from tabela_provasenem where (ano=$hoje and dia='2° Dia') order by nomeprova;");
  while ($dados=$consulta2->fetch_array()) { 
    echo "2° Dia - <a href='provas_enem/".$dados['prova']."'>".$dados['nomeprova']."</a> - <a href='provas_enem/".$dados['gabarito']."'>Gabarito</a><br>";
  }
  echo "<br>";
  $hoje = $hoje - 1;
