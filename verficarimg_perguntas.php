...
$consulta = mysqli_query($conexao,"SELECT * from tabela_pergunta where imagem != 'Não possui';");
...
while ($dado=$consulta->fetch_array()) {
    ...
    $cod_dis = $dado['codigo_disciplina'];
    ...
    echo "<b>Código da pergunta: </b><a href='alterar_questao.php?codigo=$dado[codigo_pergunta]'>" . $dado['codigo_pergunta'] . "</a>";
    ...
    echo "<b>Nome da Imagem: </b>" . $dado['imagem'];

    echo "<br>";

    echo "<img width='300' src='uploads/". $dado['imagem'] . "'>";
